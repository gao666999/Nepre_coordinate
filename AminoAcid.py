...
class AminoAcid:
    ...
    def EstablishCoordinate(self):
        #print self.N,self.center,self.CA
        ...
        #print np.sqrt(np.dot(self.xAxis,self.xAxis))
        #print np.dot((self.CA - self.center), self.xAxis)
        #print self.xAxis
        #print np.dot(self.xAxis,self.yAxis)
